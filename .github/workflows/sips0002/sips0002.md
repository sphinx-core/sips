...
![](https://github.com/sphinx-core/sips/blob/main/.github/workflows/sips0002/Hashtree%20for%20sphincs%20blockckhain.png)
...
Charlie verifies the proof and signature:

* Proof Verification:

$$
isValidProof=VerifySigProof(receivedProof,proof)
$$

* Signature Verification:

$$
isValidSig=VerifySignature(receivedMessage,σ,receivedPK,R)
$$


If both $isValidProof = True$ and $isValidSig = True$, the message is verified.