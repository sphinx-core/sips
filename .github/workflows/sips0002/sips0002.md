...
$$
𝜋 = GenerateSigProof(𝑀, 𝑝𝑘𝐵𝑦𝑡𝑒𝑠, p, R)
$$
...
* $R$= merkleRootHash(the root hash of the Merkle tree)
...
$$
isValidProof =VerifySigProof(M, 𝑝𝑘𝐵𝑦𝑡𝑒𝑠, R)
$$

Where:

* $𝑀$ = receivedMessage
* $𝑝𝑘𝐵𝑦𝑡𝑒𝑠$ = receivedPK (Alice's public key)
* $R$ = merkleRootHash (Alice's HashTree)