...
# Sphinx Wallet Address Generation

This package contains functions for generating and decoding Sphinx wallet addresses using a cryptographic method involving SphinxHash, SHA-512/224 (as a more quantum-resistant alternative to RIPEMD-160) — see the specification **[here](https://github.com/sphinx-core/sips/blob/main/.github/workflows/sips0001/sips0001.md)** — and Base58 encoding.
